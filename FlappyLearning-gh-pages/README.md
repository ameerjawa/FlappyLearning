# Flappy Learning ([Demo](http://ameerjawa.github.io/FlappyLearning/))
...
![alt tag](https://github.com/ameerjawa/FlappyLearning/blob/gh-pages/img/flappy.png?raw=true)

### [NeuroEvolution.js](http://github.com/ameerjawa/FlappyLearning/blob/gh-pages/Neuroevolution.js) : Utilization
```javascript
// Initialize
...
You can see the NeuroEvolution integration in Flappy Bird in [Game.js](http://github.com/ameerjawa/FlappyLearning/blob/gh-pages/game.js).
